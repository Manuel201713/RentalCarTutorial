...
@ComponentScan({"com.rentcar.webapp.config"})
...
public class HibernateConfig {
    ...
    {
        //bean che genera l'entity manager
        LocalContainerEntityManagerFactoryBean factory = new LocalContainerEntityManagerFactoryBean();

        factory.setJpaVendorAdapter(this.jpaVendorAdapter());
        factory.setDataSource(this.dataSource);
        factory.setPackagesToScan("com.rentcar.webapp.entity"); // dove hibernate cerca le classi entity
        factory.setJpaProperties(this.hibernateProperties()); //specifica le priprietà lette nell application.properties
